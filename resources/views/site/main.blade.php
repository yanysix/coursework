...
<div class="container2">
    ...
    <div class="container3">
        <p class="proect"> Мы можем предложить вам уникальный букет по вашему знаку Зодиака! 🌟<br><br>
            Узнайте, какой цветок идеально подойдёт именно вам.
            <button class="buttons">Подобрать букет</button>
    </div>
</div>
